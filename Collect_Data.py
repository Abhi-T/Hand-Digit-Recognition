...
while True:
    ...
    cv2.putText(frame, 'ImageCount : ', (10,100), cv2.FONT_HERSHEY_PLAIN, 1, (0, 255, 255), 1)
    ...
    #drawing the ROI
    #increment decrement is to compensate for the boundry box
    ...
    if interrupt & 0xFF==ord('0'):
        ...
        # kernel = np.ones((1, 1), np.uint8)
        # img = cv2.dilate(mask, kernel, iterations=5)
